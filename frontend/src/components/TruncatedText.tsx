    ...
    <>
      ...
      {rect &&
        createPortal(
          <div
            style={popoverStyle()}
            className="bg-black/90 border border-white/8 text-zinc-100 text-xs p-3 rounded-lg shadow-2xl select-text whitespace-pre-wrap break-all max-h-48 overflow-y-auto"
